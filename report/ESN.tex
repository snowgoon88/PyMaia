...
$Y = W^{out}M$
\end{center}
avec $M = [1; U; X]$ où $U$ la matrice des $u(n)$, $X$ la matrice des $x(n)$. Nous avons donc là un classique problème de régression linéaire que nous allons résoudre avec une \textit{ridge regression}. Nous obtenons donc:
\begin{center}
